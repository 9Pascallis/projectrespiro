          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 style="justify-content: center; text-align: center; margin-top: 10px"><b>WORKSHEET</b> </h5>
              </div>
              <!-- /.card-header -->
              <br>
              <div class="row mb-2">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-center">
                      <a class="btn btn-primary btn-sm" href="/detailworksheet"><i class="fas fa-folder"></i> View</a>
                    </td>                  
                  </tr>
                  <tr>
                    <td>2</td>
