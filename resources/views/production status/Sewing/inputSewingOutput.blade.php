            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 style="justify-content: center; text-align: center; margin-top: 10px"><b>INPUT SEWING
                                OUTPUT</b> </h5>
                    </div>
                    <!-- /.card-header -->
                    <br>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="/dashboard-sewing-output" class="btn btn-secondary" role="button"
                                aria-pressed="true">Back</a>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal1">Sewing Ke 1</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal2">Sewing Ke 2</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal3">Sewing Ke 3</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal4">Sewing Ke 4</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal5">Sewing Ke 5</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal6">Sewing Ke 6</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal7">Sewing Ke 7</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal8">Sewing Ke 8</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal9">Sewing Ke 9</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal10">Sewing Ke 10</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal11">Sewing Ke 11</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal12">Sewing Ke 12</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal13">Sewing Ke 13</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal4">Sewing Ke 14</button>
                            &ensp;
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#exampleVerticallycenteredModal15">Sewing Ke 15</button>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="1">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="2">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="3">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="4">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="5">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="6">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="7">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="8">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="9">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="10">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="11">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="12">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="13">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="14">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/insert-sewing" method="POST">
                                            @csrf
                                            <input type="hidden" name="id_process_sewing" value="15">
                                            <input type="hidden" name="id_worksheet" value="{{ $worksheet->id }}">
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-3 col-form-label">Warna</label>
                                                <div class="col-sm-8">
