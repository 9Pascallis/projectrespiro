          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 style="justify-content: center; text-align: center; margin-top: 10px"><b>INPUT SEWING OUTPUT</b> </h5>
                </div>
                <!-- /.card-header -->
                <br>
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                                ...
                                <label for="inputText" class="col-sm-3 col-form-label">Sewing</label>
                                 <div class="col-sm-8">
                                      <select class="form-control select2" style="width: 100%;">
                                        ...
                                        <option>Sewing ke 1</option>
                                        <option>Sewing ke 2</option>
                                        <option>Sewing ke 3</option>
                                        <option>Sewing ke 4</option>
                                        <option>Sewing ke 5</option>
                                        <option>Sewing ke 6</option>
                                        <option>Sewing ke 7</option>
                                        <option>Sewing ke 8</option>
                                        <option>Sewing ke 9</option>
                                        <option>Sewing ke 10</option>
                                        <option>Sewing ke 11</option>
                                        <option>Sewing ke 12</option>
                                        <option>Sewing ke 13</option>
                                        <option>Sewing ke 14</option>
                                        <option>Sewing ke 15</option>
                                        </select>
                                    </div>  
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="/dashboard-sewing-output" class="btn btn-outline-info px-3 " role="button" aria-pressed="true">Save</a>
                        </div>
                </div>
                <!-- /.card-body -->
            </div>
