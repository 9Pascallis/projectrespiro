          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 style="justify-content: center; text-align: center; margin-top: 10px"><b>EDIT SCHEDULE</b> </h5>
                </div>
                <!-- /.card-header -->
                <br>
                <div class="card-body">
                    ...
                    <div class="row" style="margin-left: 20px; margin-right: 20px">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        value="{{ $schedule->worksheet->nomor_ws }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="id_production_plan" class="form-control"
                                        value="{{ $schedule->worksheet->productionPlan->konfirmasi_permintaan->permintaan->nama_produk }}" disabled>
                                    </div>
                                </div>   
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="id_production_plan" class="form-control"
                                        value="{{ date('d-m-Y', strtotime($schedule->worksheet->productionPlan->konfirmasi_permintaan->permintaan->target_delivery )) }}" disabled> </div>                                    </div>
                        ...
                        <form action="/update-schedule/{{$schedule->id}}" method="POST">
                        @csrf
                                ...
                                <div id="PPM" class="menu">
                                    <div class="row mb-3" id="PPM" class="menu">
                                        ...
                                        <div class="col-sm-8" id="PPM" >
                                            <input type="date" name="ppm" class="form-control" value="{{ $schedule->ppm }}">
                                ...
                                <div id="CUTTING" class="menu">
                                    <div class="row mb-3" id="CUTTING" >
                                        ...
                                        <div class="col-sm-4">
                                        <input type="date" name="cutting_mulai" class="form-control" value="{{ $schedule->cutting_mulai }}">
                                        </div>
                                        _
                                        <div class="col-sm-4" >
                                        <input type="date" name="cutting_selesai" class="form-control" value="{{ $schedule->cutting_selesai }}">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div id="SEWING" class="menu">
                                    <div class="row mb-3" id="SEWING" >
                                        ...
                                        <div class="col-sm-4">
                                        <input type="date" name="sewing_mulai" class="form-control" value="{{ $schedule->sewing_mulai }}">
                                        </div>
                                        _
                                        <div class="col-sm-4"  >
                                        <input type="date" name="sewing_selesai" class="form-control" value="{{ $schedule->sewing_selesai }}">
                                        </div>
                                    </div>            
                                </div>               
