      ...
      <div class='box-login'>
        <div class='fieldset-body' id='login_form'>
            <div style="padding-top: 40px; padding-bottom: 10px">
                <img src="{{asset('AdminLTE')}}/dist/img/logoorange.png" height="35px">
            </div>
            ...
            <div style="padding-top: 10px; padding-bottom: 40px; padding-left: 40px; padding-right: 40px">
...
body {
  background: rgb(47, 45, 48);
background: -moz-linear-gradient(-45deg, #212529 0%, #25282B 100%);
background: -webkit-gradient(left top, right bottom, color-stop(0%, #FFFFFF), color-stop(100%, #040c27));
background: -webkit-linear-gradient(-45deg, #212529 0%, #25282B 100%);
background: -o-linear-gradient(-45deg, #212529 0%, #25282B 100%);
background: -ms-linear-gradient(-45deg, #212529 0%, #25282B 100%);
background: linear-gradient(135deg, #212529 0%, #25282B 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#212529', endColorstr='#25282B', GradientType=1 );
}
