            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 style="justify-content: center; text-align: center; margin-top: 10px"><b>Warna</b>
                        </h5>
                    </div>
                    <!-- /.card-header -->
                    <br>
                    <div class="card-body">
                        ...
                        <form action="/insert-Warna" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Nama Warna</label>
                                <div class="col-sm-10">
                                    <input type="text" name="nama_warna"   value="{{old('nama_warna')}}"
                                    class="form-control @error('nama_warna') is-invalid @enderror me-2"
                                    required>
                                @error('nama_warna')
